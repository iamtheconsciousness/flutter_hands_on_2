...
import 'package:flutter_hands_on_2_database/Dialog.dart';
                                    ...
                                    Container(
                                      ...
                                      child: ToggleSwitch(
                                        ...
                                        onToggle: (state) {
                                          ...
                                          String update_state_url ='https://newdoonchemist.ml/update.php?table=$table&id=$id&state=$state';
                                          update_services.getAccess(update_state_url).then((tab)  async{
                            ...
                            Container(
                              ...
                              child: ToggleSwitch(
                                ...
                                onToggle: (state) {
                                  ...
                                  if(state==0){
                                    String update_flag_url ='https://newdoonchemist.ml/update_flag.php?table=$table&id=$id&flag=0';
                                    update_services.getAccess(update_flag_url).then((tab)  async{
                                    });
                                  }
                                  String update_state_url ='https://newdoonchemist.ml/update.php?table=$table&id=$id&state=$state';
                                  print(update_state_url);
                                  update_services.getAccess(update_state_url).then((tab)  async{
                                  });
                                  },
                              ),
                            ...
                            Container(
                              ...
                              child: ToggleSwitch(
                                ...
                                onToggle: (state) {
                                  ...
                                  if(state==0){
                                    String update_variable_url ='https://newdoonchemist.ml/update_variable.php?table=$table&id=$id&variable=24';
